        ...
        stage('Download and run Images') {
            ...
            steps{
                sshagent(credentials : ['the-key']) {
                     sh '''ssh gabrielkovacs@swa-kovacs-vm2.cs.univie.ac.at "/snap/bin/docker pull pufarin/sr:sr-v9.0 | /snap/bin/docker run -d --restart=always  -p 8085:8085 pufarin/sr:sr-v9.0" '''
                     sh '''ssh gabrielkovacs@swa-kovacs-vm3.cs.univie.ac.at "/snap/bin/docker pull pufarin/oprop:oprop-v9.0 | /snap/bin/docker run -d --restart=always  -p 8083:8083 pufarin/oprop:oprop-v9.0" '''
                     sh '''ssh gabrielkovacs@swa-kovacs-vm4.cs.univie.ac.at "/snap/bin/docker pull pufarin/dr:dr-v9.0 | /snap/bin/docker run -d --restart=always  -p 8086:8086 pufarin/dr:dr-v9.0" '''
                     sh '''ssh gabrielkovacs@swa-kovacs-vm1.cs.univie.ac.at "/snap/bin/docker pull pufarin/ag:ag-v9.0 | /snap/bin/docker run -d --restart=always  -p 8082:8082 pufarin/ag:ag-v9.0" '''
