    ...
    stages {
        stage('Build') {
            steps {
                ...
                sh "cp -v /var/lib/jenkins/workspace/j1/orderProductsAndReceiveOrderedProducts/target/*.jar /home/gabriel/gabriel/deploy/orderProductsAndReceiveOrderedProducts-0.0.1-SNAPSHOT.jar"
