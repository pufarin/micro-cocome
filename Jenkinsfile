    ...
    */
    stages {
        stage('Build') {
            ...
            steps {
                echo 'Building..'
                sh 'mvn -f /var/lib/jenkins/workspace/api_gateway_1_to_1_db/orderProductsAndReceiveOrderedProducts/pom.xml clean package'
                sh 'mvn -f /var/lib/jenkins/workspace/api_gateway_1_to_1_db/showDeliveryReports/pom.xml clean package'
                sh 'mvn -f /var/lib/jenkins/workspace/api_gateway_1_to_1_db/showStockReports/pom.xml clean package'
                sh 'mvn -f /var/lib/jenkins/workspace/api_gateway_1_to_1_db/api-gateway/pom.xml clean package'
