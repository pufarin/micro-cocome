    ...
    stages {
        stage('Build') {
            steps {
                ...
                sh "cp /var/lib/jenkins/workspace/j1/orderProductsAndReceiveOrderedProducts/target/*.jar /home/gabriel/deploy/orderProductsAndReceiveOrderedProducts-0.0.1-SNAPSHOT.jar"
